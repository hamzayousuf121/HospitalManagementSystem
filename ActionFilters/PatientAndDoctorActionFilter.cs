...
{
    public class PatientAndDoctorActionFilter : Attribute, IActionFilter
    {
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            User user = _context.Users.Where(x => x.AccessToken == accessToken && x.Role.Name == "Doctor" || x.Role.Name == "Patient").FirstOrDefault();
